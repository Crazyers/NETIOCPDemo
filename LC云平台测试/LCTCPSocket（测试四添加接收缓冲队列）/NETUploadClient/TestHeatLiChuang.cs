...
namespace NETUploadClient
{
    public class TestHeatLiChuang
    {
        ...
        protected void InitTask()
        {
            ...
            string strIP = "172.16.6.117";
            //throughputSocket.Connect("172.16.6.114", 9999);
            liChuangSocket1.Connect(strIP, 9999);
            liChuangSocket2.Connect(strIP, 9999);
            liChuangSocket3.Connect(strIP, 9999);
            liChuangSocket4.Connect(strIP, 9999);
            liChuangSocket5.Connect(strIP, 9999);
